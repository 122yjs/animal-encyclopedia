...
## Corpus Check
- 13 files · ~525,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 557 nodes · 1271 edges · 28 communities detected
...
Cohesion: 0.07
Nodes (57): activateMissionRegion(), applyInitialMissionSettings(), applyQuestionToolMode(), bindMissionPanel(), bindTeacherMissionControls(), bindViewTabs(), canOpenQuestionSettings(), closeReward() (+49 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (30): buildObservationDetails(), escapeAttribute(), escapeHTML(), getFocusableElements(), handleModalKeydown(), lifeBrief(), lifestyleExplanation(), makeAnimal() (+22 more)
...
Cohesion: 0.09
Nodes (26): clearOnboardingHighlights(), closeGuideModal(), closeQrExpand(), closeRegionLockedPopup(), closeSettings(), completeOnboarding(), confirmLockedRegionTravel(), enterModalFocus() (+18 more)
...
Cohesion: 0.19
Nodes (13): answerQuestion(), clearHintHighlight(), escapeHTML(), finishQuiz(), nextQuestion(), renderFeedback(), renderObservationSummary(), renderQuickFacts() (+5 more)
...
- **Why does `playSound()` connect `Community 5` to `Community 1`, `Community 2`, `Community 7`, `Community 16`, `Community 18`?**
